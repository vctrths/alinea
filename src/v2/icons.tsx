...
export function IcRoundArrowUpward(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M4 12c0 .55.45 1 1 1h8v5c0 .89 1.08 1.34 1.71.71l5.29-5.29a.996.996 0 0 0 0-1.41l-5.29-5.29C14.08 6.09 13 6.54 13 7.43V11H5c-.55 0-1 .45-1 1"
      />
    </svg>
  )
}
...
export function IcRoundArrowDownward(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M20 12c0-.55-.45-1-1-1h-8V6c0-.89-1.08-1.34-1.71-.71L4 10.58a.996.996 0 0 0 0 1.41l5.29 5.29c.63.63 1.71.18 1.71-.71V13h8c.55 0 1-.45 1-1"
      />
    </svg>
  )
}
...
export function IcRoundSwapHoriz(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      <path
        fill="currentColor"
        d="m6.14 11.86l-2.78 2.79c-.19.2-.19.51 0 .71l2.78 2.79c.31.32.85.09.85-.35V16H13c.55 0 1-.45 1-1s-.45-1-1-1H6.99v-1.79c0-.45-.54-.67-.85-.35m14.51-3.21l-2.78-2.79c-.31-.32-.85-.09-.85.35V8H11c-.55 0-1 .45-1 1s.45 1 1 1h6.01v1.79c0 .45.54.67.85.35l2.78-2.79c.2-.19.2-.51.01-.7"
      />
    </svg>
  )
}
